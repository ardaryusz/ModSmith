...
The easiest way to get started with ModSmith on Windows is by downloading and running the pre-built installer: `modsmith_<version>_<arch>-setup.exe` (e.g., `modsmith_2.1.2_x64-setup.exe`).
